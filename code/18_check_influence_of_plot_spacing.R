...
save(
  ...
  plot_df, 
  allsum,
  file = "distance_metacommunity_results.RData")

ggsave("figure_s05.png",
       plot = p_shift, 
...
allsum |> 
  ...
  geom_point(size = 3) +
  labs(x = "Distance x Biodiversity interaction") +
  theme_minimal() +
